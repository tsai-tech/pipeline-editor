/**
 * `@tsai-pe/shared/theme` — design tokens + global stylesheet.
 *
 * The real payload of this library is CSS, consumed via
 * `@import '@tsai-pe/shared/theme';` (see `src/index.css` / `src/theme.css`).
...
export const themeStylesheet = '@tsai-pe/shared/theme/index.css';

/** Raw design tokens as CSS custom properties (source of truth). */
export const themeTokensStylesheet = '@tsai-pe/shared/theme/theme.css';
